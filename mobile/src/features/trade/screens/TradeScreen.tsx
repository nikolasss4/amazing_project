...
import { runConnectionTests, getAPIConfig } from '../../wallet/services/testConnection';
...
export const TradeScreen: React.FC = () => {
  ...
  // Wallet state
  const { isConnected, walletAddress, isConnecting, connect, disconnect, initialize } = useWalletStore();
